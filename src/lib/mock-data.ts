...
const FALLBACK_COPY: SynthCopy = {
  ...
  sentences: [
    ...
    "Read the question twice — half the mistakes here are answers to a different one.",
    "The method is the same whether the numbers are small or enormous.",
    "If a step feels arbitrary, you have not found the reason for it yet.",
    "Draw it before you calculate; the picture usually does half the work.",
    "Check the units at the end and most slips announce themselves.",
    "The hard part is deciding which rule applies, not applying it.",
    "Do the easy version first, then change one thing at a time.",
    "A definition you can use is worth more than one you can recite.",
    "When two things look alike, name the difference out loud.",
    "Estimate the answer first — then you know whether the result is sane.",
    "The order of the steps is not decoration; swap two and the answer moves.",
    "Every worked example here hides the same three decisions.",
    "If you get stuck, go back one card — the missing piece is usually there.",
    "Say what you are looking for before you start looking for it.",
    "The exam version of this looks longer, but it asks for exactly this.",
    "Practise the move on something boring until it needs no thought.",
    "Two wrong attempts teach more than one lucky guess.",
    "You have finished this idea when you can explain it to someone else.",
  ],
};
