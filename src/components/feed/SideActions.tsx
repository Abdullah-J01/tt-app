...
const SideActions = forwardRef<SideActionsHandle, { card: FeedCardData }>(function SideActions(
  ...
  return (
    ...
    <div className="absolute right-2 bottom-[calc(4.25rem+env(safe-area-inset-bottom))] z-20 flex flex-col items-center gap-4 sm:right-6 sm:bottom-[calc(7rem+env(safe-area-inset-bottom))] lg:top-1/2 lg:right-auto lg:bottom-auto lg:left-full lg:ml-5 lg:-translate-y-1/2">
