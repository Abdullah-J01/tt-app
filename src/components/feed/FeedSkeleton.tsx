...
export function FeedCardSkeleton() {
  return (
    <div aria-hidden="true" className="bg-plum-gradient relative h-full w-full overflow-hidden">
      ...
      {/* <div className="absolute inset-x-5 top-4 flex gap-1 sm:inset-x-7 sm:top-5">
      ...
      <div className="absolute inset-x-5 top-8 flex items-center justify-between sm:inset-x-7 sm:top-9">
      ...
      {/* subject · grade pill */}
      <div className="absolute inset-x-5 top-19 sm:inset-x-7 sm:top-20">
        <Skeleton className="h-7 w-36 rounded-full bg-white/15" />
      </div>

      {/* main content: kicker, title, description */}
      <div className="absolute inset-x-5 top-[38%] -translate-y-1/2 sm:inset-x-8 sm:top-[40%]">
      ...
      {/* book author row */}
      <div className="absolute inset-x-5 bottom-6 flex items-center gap-3 sm:inset-x-8 sm:bottom-8">
...
export function SideActionsSkeleton() {
  return (
    <div
      aria-hidden="true"
      className="absolute right-3 bottom-24 z-20 flex flex-col items-center gap-4 sm:right-4 sm:bottom-28 lg:top-1/2 lg:right-auto lg:bottom-auto lg:left-full lg:ml-5 lg:-translate-y-1/2"
    >
