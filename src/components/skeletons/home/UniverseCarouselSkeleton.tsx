 ...
 * Reserves the carousel's scroll track (100vh + 4 cards × 14vh mobile /
 * 20vh desktop) with a sticky stage, and sketches the focused cover flanked
 * by two receding neighbours at the deck's 40% anchor. Reduced-motion mirrors
 * the flat card rail fallback instead.
 */
export function UniverseCarouselSkeleton() {
  return (
    <div role="status" aria-label="Loading">
      {/* pinned spiral variant */}
      <div className="hidden h-[156vh] motion-safe:block sm:h-[180vh]">
        <div className="sticky top-0 h-screen overflow-hidden">
          <div className="absolute top-[40%] left-1/2 -translate-x-1/2 -translate-y-1/2">
            <div className="relative flex items-center justify-center">
              ...
              {/* focused cover */}
              <div className="rounded-card relative aspect-[1/1.36] w-[60vw] max-w-[240px] overflow-hidden sm:w-[340px] sm:max-w-none">
